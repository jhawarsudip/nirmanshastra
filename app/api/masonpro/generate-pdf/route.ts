...
export async function POST(req: NextRequest) {
  try {
    ...
    if (contactInfo.email) {
      try {
        const { error: emailErr } = await resend.emails.send({
          ...
          subject: `Your MasonPro Report is Ready — ${reportId}`,
    ...
    console.error('masonpro generate-pdf error:', err)
...
<head>
  ...
  <title>Your MasonPro Report</title>
</head>
        ...
        <table width="580" cellpadding="0" cellspacing="0" style="background:#F4F4F0;border:1px solid #1E2227;max-width:580px;">
            ...
            <td style="padding:20px 28px;border-bottom:1px solid #1E2227;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <span style="display:inline-block;border:1px solid #1F4E79;padding:4px 10px;font-family:'IBM Plex Mono',Courier,monospace;font-size:9px;color:#1F4E79;">PHASE 2 · MASONPRO</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:28px 28px 20px;">
              ...
              <h1 style="margin:0 0 16px;font-family:'IBM Plex Serif',Georgia,serif;font-size:22px;color:#1E2227;font-weight:700;">Your MasonPro Report is Ready</h1>
              ...
              <p style="margin:0 0 14px;font-family:'IBM Plex Sans',Arial,sans-serif;font-size:14px;color:#1E2227;line-height:1.6;">
                Thank you for using NirmanShastra MasonPro. Your Phase 2 Masonry cost estimate report
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 20px;">
                <tr>
                  <td style="background:#EBF0F7;border:1px solid #1F4E79;padding:14px 20px;">
                    <p style="margin:0 0 4px;font-family:'IBM Plex Mono',Courier,monospace;font-size:9px;color:#1F4E79;letter-spacing:1px;">9-PAGE IS 1077:1992 + IS 2212:1991 REPORT INCLUDES:</p>
              ...
              <p style="margin:0 0 10px;font-family:'IBM Plex Sans',Arial,sans-serif;font-size:13px;color:#1E2227;line-height:1.6;">
                ...
                Use ElectroPro to estimate wire lengths, MCB ratings, DB schedule, and earthing before your electrician quotes you.
              </p>
              <a href="${appUrl}/tools/electropro" style="font-family:'IBM Plex Sans',Arial,sans-serif;font-size:13px;color:#1F4E79;text-decoration:underline;">
                Try ElectroPro Phase 3 &rarr; Rs.499
              </a>
            </td>
          </tr>
