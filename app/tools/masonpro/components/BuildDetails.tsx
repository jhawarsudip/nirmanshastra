            ...
            <div>
              ...
              {!showRates && (
                <p className="text-[11px] text-left mt-0.5" style={{ color: '#14532D', fontFamily: 'var(--font-plex-mono)' }}>
                  ✓ India Average 2026 · Edit if you have local quotes
                </p>
              )}
            </div>
            <span style={{ color: 'rgba(30,34,39,0.4)', fontFamily: 'var(--font-plex-mono)', fontSize: 12 }}>{showRates ? '▲' : '▼'}</span>
          </button>
          {showRates && (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] whitespace-nowrap" style={{ color: 'rgba(30,34,39,0.4)', fontFamily: 'var(--font-plex-mono)' }}>
                        {unit} · Avg ₹{avg.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                  {MASON_REGIONAL_NOTES[key] && (
                    <p className="text-[11px] mt-0.5 ml-1" style={{ color: 'rgba(30,34,39,0.55)', fontFamily: 'var(--font-plex-sans)' }}>
                      {MASON_REGIONAL_NOTES[key]}
                    </p>
                  )}
                </div>
