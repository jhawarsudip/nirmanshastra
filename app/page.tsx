    ...
    <main className="sheet-frame min-h-screen" style={{ background: BG, position: 'relative' }}>
      ...
      <section className="grid-paper px-6 md:px-16 lg:px-24 py-28">
        <div className="space-y-14">
          <SectionHeader title={<>Why NirmanShastra<span style={{ color: GOLD, fontSize: '1.2em', marginLeft: '0.15em', verticalAlign: 'baseline' }}>?</span></>} />
      ...
      <section id="how-it-works" className="grid-paper px-6 md:px-16 lg:px-24 py-28">
        <div className="space-y-14">
          <SectionHeader title={<>How NirmanShastra <span className="section-accent">works</span><span style={{ color: GOLD, fontSize: '1.2em', marginLeft: '0.15em', verticalAlign: 'baseline' }}>?</span></>} />
      ...
      <section className="px-6 md:px-16 lg:px-24 py-28" style={{ background: BG }}>
        <div className="space-y-10">
          <SectionHeader title={<>Why NirmanShastra <span className="section-accent">beats</span> free calculators<span style={{ color: GOLD, fontSize: '1.2em', marginLeft: '0.15em', verticalAlign: 'baseline' }}>?</span></>} />
