...
function PageCover({ input, result, contact, reportId, projectName, date }: Props) {
  ...
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={1} total={9} />
...
function PageProjectSummary({ input, result, contact, reportId, projectName, date }: Props) {
  ...
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={2} total={9} />
...
function PageCompliancePanel({ result, reportId }: Props & { reportId: string }) {
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={3} total={9} />
...
function PageWallSection({ input, reportId }: Props & { reportId: string }) {
  ...
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={4} total={9} />
...
function PageWallComparison({ result, reportId }: { result: MasonResult; reportId: string }) {
  ...
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={5} total={9} />
...
function PageWaterproofingDetail({ input, result, reportId }: Props & { reportId: string }) {
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={6} total={9} />
...
function PageBrickworkBOQ({ input, result, reportId }: Props & { reportId: string }) {
  ...
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={7} total={9} />
...
function PagePlasterBOQ({ input, result, reportId }: Props & { reportId: string }) {
  ...
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={8} total={9} />
...
function PageCostSummary({ result, reportId, date }: Props & { reportId: string }) {
  ...
  return (
    <Page size="A4" style={S.page}>
      <View style={S.frame}>
        <PageHeader reportId={reportId} page={9} total={9} />
        <SectionTitle text="SHEET 09 · COST SUMMARY + NEXT PHASE" />
