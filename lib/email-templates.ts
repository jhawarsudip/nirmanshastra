...
export function getEmailContent(
  ...
  switch (sequenceType) {
      ...
      if (dayNumber === 120) {
        return {
          ...
          html: wrap(`
            ...
            ${p(`<b>Bundle offer:</b> Get all 5 paid reports (StructoPro + MasonPro + ElectroPro + PlumbPro + InteriorPro) for ${mono('₹2,999')} — saving ₹1,496 vs buying individually.`)}
      ...
      if (dayNumber === 120) {
        return {
          ...
          html: wrap(`
            ...
            ${p(`<b>Bundle offer:</b> All 5 paid reports for ${mono('₹2,999')} — saves ₹1,496 versus buying individually. If you have already purchased StructoPro, your remaining bundle price is reduced automatically.`)}
            ${ctaButton('Estimate Interiors → InteriorPro ₹499', `${BASE_URL}/interiorpro`)}
      ...
      if (dayNumber === 120) {
        return {
          ...
          html: wrap(`
            ...
            ${p(`<b>Bundle:</b> All 5 paid reports for ${mono('₹2,999')} — saving ₹1,496 versus individual purchase.`)}
            ${ctaButton('Estimate Interiors → InteriorPro ₹499', `${BASE_URL}/interiorpro`)}
            ${ctaButton('Complete Bundle → ₹2,999', `${BASE_URL}/#pricing`, '#1F4E79')}
          `),
        }
      ...
      if (dayNumber === 120) {
        return {
          ...
          html: wrap(`
            ...
            ${p(`<b>All 5 paid reports</b> (StructoPro + MasonPro + ElectroPro + PlumbPro + InteriorPro) for ${mono('₹2,999')} — saving ₹1,496 versus buying individually at ₹499 each.`)}
    ...
    case 'plumbpro': {
      ...
      if (dayNumber === 75) {
        return {
          ...
          html: wrap(`
            ...
            ${p(`<b>All 5 paid reports</b> for ${mono('₹2,999')} — saving ₹1,496. Includes StructoPro, MasonPro, ElectroPro, PlumbPro, and InteriorPro.`)}
      ...
      if (dayNumber === 120) {
        return {
          subject: 'Bundle Upgrade Offer — Save ₹1,496 | NirmanShastra',
          html: wrap(`
            ...
            ${p(`<b>Complete bundle:</b> All 5 paid reports for ${mono('₹2,999')}. Your existing PlumbPro purchase counts toward the bundle price.`)}
      ...
      if (dayNumber === 0) {
        return {
          ...
          html: wrap(`
            ...
            ${p(`<b>Bundle offer:</b> All 5 paid reports for ${mono('₹2,999')} — saving ₹1,496. Includes Grand Total Report free.`)}
      ...
      if (dayNumber === 75) {
        return {
          ...
          html: wrap(`
            ...
            ${p(`<b>Bundle:</b> StructoPro + MasonPro + ElectroPro + PlumbPro + InteriorPro for ${mono('₹2,999')} + Grand Total Report FREE.`)}
